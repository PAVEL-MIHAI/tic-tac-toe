...
console.log(" Всего 45 баллов ");
console.log(" 10 верстка");
console.log(" 10 клик по полю отображается крестик");
console.log(" 10 игра завершается когда три одинаковые фигуры по горизонтали, вертикали или диагонали");
console.log(" 5 по окончании показывает победителя");
console.log(" 10 анимация");
